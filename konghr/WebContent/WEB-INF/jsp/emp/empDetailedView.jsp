  ...
  $(document).ready(function(){
	...
	////////////////////////////////////////////////////그리드이벤트////////////////////////////////////////////////////////	  
	  ...
	  function removeEmpListN() {
	  		var selectedRowIds = $("#namefindgrid").getGridParam("selarrrow");
	  		...
	  		$.each(selectedRowIds, function(index, id){
	  			var data = $("#namefindgrid").getRowData(id);
	  			selectedRowData.push(data);
	  		});
	...
	//자격증정보 그리드 호출
	  ...
	  $("#btn_dept_del").click(function(){ removeEmpListD(); });
	  $("#btn_name_del").click(function(){ removeEmpListN(); });
