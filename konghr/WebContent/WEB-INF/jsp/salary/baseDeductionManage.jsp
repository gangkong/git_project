    ...
    function showBaseDeductionListGrid(){
    	...
    	$("#baseDeductionList_grid").jqGrid({
			...
			ondblClickRow: function(id){
				...
				if (rowData.status == "normal") { // 서버에서 불러온 자료일 경우 상태를 update로 변경
...
<body>
	<div id="baseDeductionList_tabs">
		...
		<div id="baseDeductionList_tab">
			<button class="ui-button ui-widget ui-corner-all" id="add_baseDeduction_Btn">추가</button>
			<button class="ui-button ui-widget ui-corner-all" id="del_baseDeduction_Btn">삭제/삭제취소</button>
